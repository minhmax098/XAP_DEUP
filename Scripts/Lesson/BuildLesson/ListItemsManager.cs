...
namespace BuildLesson
{
    public class ListItemsManager : MonoBehaviour
    {
        ...
        void RecordLesson()
        {
            ...
            panelRecord.transform.GetChild(0).GetChild(1).GetComponent<Text>().text = panelAddAudio.transform.GetChild(0).GetChild(1).GetComponent<Text>().text;
        }
        ...
        IEnumerator SaveAddVideoLabel(int labelId, string video)
        {
            ...
            else
            {
                if (webRequest.isDone)
                {
                    ...
                    videoObj.GetComponent<Image>().sprite = null;
                    videoObj.transform.GetChild(0).GetComponent<Button>().onClick.RemoveAllListeners();
                    // UpdateLessonInfoPanel(labelId);
                    toggleListItemAnimator.SetBool(AnimatorConfig.isShowMeetingMemberList, true);
                    // StartCoroutine(LoadDataListItemPanel.Instance.UpdateLessonInforPannel(labelId));
        ...
        void HandlerRedRecord()
        {
            ...
            else 
            {
                ...
                panelSaveRecord.transform.GetChild(0).GetChild(1).GetComponent<Text>().text = panelRecord.transform.GetChild(0).GetChild(1).GetComponent<Text>().text;
        ...
        //         videoObj.GetComponent<RawImage>().sprite = sprite;
        //         videoObj.transform.GetChild(0).GetComponent<Button>().onClick.AddListener(() => VideoManagerBuildLesson.Instance.ShowVideo(videoUri));
